...
1) указания авторства библиотеки

2) отправка лучей добра всем членам команды FastFlow team

3) при нахождении багов и уязвимых мест сообщать на почту fastflowteam@yandex.ru
